...
## 7.2 Columnas para el Modelo RF

Ratio: keep variables log scaled (better for the split with a sckewed vb) and the dummies (binary split better?). 
...
# remove instrumentalness_log_scaled
...
write.csv(df_rn, file = file.path(path_intermediate, "train_rn.csv"),
          row.names = FALSE)
